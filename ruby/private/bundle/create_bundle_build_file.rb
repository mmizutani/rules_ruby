...
# Since OS platform is unlikely to change between Bazel builds on the same machine, `#{gem_name}-#{gem_version}*`
# would be sufficient to narrow down matches to at most one.
...
# For gems with native extension installed via prebuilt packages, the last part of this path can
# contain an OS-specific suffix like 'grpc-1.38.0-universal-darwin.gemspec' or 'grpc-1.38.0-x86_64-linux.gemspec'
# instead of 'grpc-1.38.0.gemspec'.
